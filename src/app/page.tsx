...
export default function Home() {
  return (
    <main>
      <div className="home container min-h-screen flex flex-col items-center justify-center overflow-x-hidden">
        <Link
          href="/about"
          className="about h-20 my-8 md:my-10 text-center relative group lg:-left-40 "
        >
          <h1 className="text-6xl md:text-7xl  font-extralight group-hover:text-7xl md:group-hover:text-[5.5rem]   transition-all duration-300 select-none">
            About
          </h1>
        ...
        >
          ...
          <h3 className="text-md lg:text-lg font-bold uppercase select-none">
            What i can do for you <span className="text-2xl">.</span>
          </h3>
        ...
        <Link
          href="/contact"
          className="connect h-20 my-8 md:my-10 text-center relative group lg:-left-24 "
        >
          <h1 className="text-6xl md:text-7xl  font-extralight group-hover:text-7xl md:group-hover:text-[5.5rem]  transition-all duration-300 select-none">
            Connect
          </h1>
